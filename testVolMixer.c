...
/*
    ...
    Simple test to set volume using ALSA mixer controls.
...
//  Compilation:
//
//  Compile with gcc testVolMixer.c -o testVolMixer -lasound
...
void main( int argc, char *argv[] )
{
    ...
    snd_mixer_attach( handle, cmdArgs.card )
...
//    }
    ...
    {
        errNum = snd_mixer_selem_id_set_index( id, loop );
        if errN
